...
Usage:
    ./classify_disease.py --input image.jpg \
...
def run_inference(input_path: str, output_file: str):
    """Run inference on input images."""
    # Load model
    model, label_mapping, framework = load_model()
    ...
    # Classify images
    results = classify_images(model, str(input_path), label_mapping, framework)
...
def main():
    parser = argparse.ArgumentParser(
        description="Classify crop diseases from image"
    )
